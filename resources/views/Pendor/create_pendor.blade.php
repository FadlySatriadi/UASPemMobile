                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><strong>PENDOR</strong></span>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('simpan_pendor')}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input type="text" id="nama_pendor" name="nama_pendor" class="form-control" placeholder="Nama Vendor">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="sosmed" name="sosmed" class="form-control" placeholder="Sosmed">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_pendor')}}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; VEXXY</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
