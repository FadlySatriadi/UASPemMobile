            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Edit Detail Pakaian</h1>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="/update_alternatif/{{$dtAlternatif->id}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="warna" name="warna" class="form-control" placeholder="Jumlah Permintaan" value="{{$dtAlternatif->warna}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="harga" name="harga" class="form-control" placeholder="Harga" value="{{$dtAlternatif->harga}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" id="stok" name="stok" class="form-control" placeholder="Stok" value="{{$dtAlternatif->stok}}">
                                    </div>
                                    <div class="form-group">
